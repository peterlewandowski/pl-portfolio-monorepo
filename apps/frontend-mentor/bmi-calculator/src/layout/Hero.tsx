            ...
            <Container>
                ...
                <div className="mt-7 flex gap-4 [&>*]:basis-1/2">
                    ...
                    <div className="inline-flex h-[30rem] w-96 flex-col items-start justify-start gap-8 rounded-2xl bg-white p-8 shadow-[16px_32px_56px_0_rgba(143,174,207,0.25)]">
                        ...
                        <div className="inline-flex items-center justify-center gap-6 self-stretch rounded-bl-2xl rounded-br-full rounded-tl-2xl rounded-tr-full bg-gradient-to-r from-blue-600 to-indigo-500 p-8">
