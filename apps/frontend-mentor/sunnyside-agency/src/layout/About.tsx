    ...
    return (
        <section id="about">
            <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="flex flex-col items-center gap-10 overflow-hidden px-6 py-16 text-center md:items-start md:p-40 md:pr-24 md:text-left">
                    <h2 className="font-fraunces normal text-4xl font-black">
                        Transform your brand
                    </h2>
                    <p className="text-lg font-semibold leading-8 text-slate-500">
                ...
                <div className="flex flex-col items-center gap-10 px-6 py-16 text-center md:items-start md:p-40 md:pl-24 md:text-left">
                ...
                <div className="relative">
                    ...
                    <div className="relative flex flex-col items-center gap-6 px-6 md:px-40 pb-14 pt-96 text-center text-[#24554A] [&>*]:max-w-xs">
                ...
                <div className="relative">
                    <Image
                        ...
                        style={{ objectFit: "cover", objectPosition: "center" }}
                    />
                    <div className="relative flex flex-col items-center gap-6 px-6 md:px-40 pb-14 pt-96 text-center text-[#052C3B] [&>*]:max-w-xs">
